...
const FriendRequests = ({ onConversationCreated }) => {
    ...
    const handleAccept = async (requestId) => {
        ...
        try {
            ...
            const response = await axios.post(
                `https://real-time-chat-app-backend-1qh4.onrender.com://real-time-chat-app-backend-1qh4.onrender.com/api/friend-requests/${requestId}/accept`,
                {},
                {
                    headers: {
                        Authorization: `Bearer ${token}`,
    ...
    const handleReject = async (requestId) => {
        ...
        try {
            ...
            await axios.post(
                `https://real-time-chat-app-backend-1qh4.onrender.com://real-time-chat-app-backend-1qh4.onrender.com/api/friend-requests/${requestId}/reject`,
                {},
                {
                    headers: {
                        Authorization: `Bearer ${token}`,
