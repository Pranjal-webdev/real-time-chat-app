...
const ChatWindow = ({ conversation, onBack }) => {
    ...
    const handleDeleteMessage = async (messageId) => {
        ...
        try {
            ...
            await axios.delete(
                `https://real-time-chat-app-backend-1qh4.onrender.com/api/messages/${messageId}`,
                {
                    headers: {
    ...
    const handleEditMessage = async (message) => {
        ...
        try {
            ...
            const response = await axios.put(
                `https://real-time-chat-app-backend-1qh4.onrender.com/api/messages/${message._id}`,
                {
                    text: newText.trim(),
                },
                {
    ...
    const handleReaction = async (messageId, emoji) => {
        try {
            ...
            const response = await axios.put(
                `https://real-time-chat-app-backend-1qh4.onrender.com/api/messages/${messageId}/reaction`,
                { emoji },
                {
                    headers: {
                        Authorization: `Bearer ${token}`,
        ...
        const fetchMessages = async () => {
            try {
                ...
                const response = await axios.get(
                    `https://real-time-chat-app-backend-1qh4.onrender.com/api/messages/${conversation._id}`,
                    {
                        headers: {
                            Authorization: `Bearer ${token}`,
                        },
                                                ...
                                                message.fileUrl && (
                                                    <>
                                                        {attachmentStatus[message._id] === "loading" ? (
                                                            ...
                                                            <img
                                                                src={`https://real-time-chat-app-backend-1qh4.onrender.com${message.fileUrl}`}
                                                                alt={message.fileName || "Image"}
                                                                className="w-48 h-48 object-contain rounded-lg"
                                                            />
                                                        ) : (
                                                ...
                                                message.fileUrl && (
                                                    <>
                                                        {attachmentStatus[message._id] === "loading" ? (
                                                            ...
                                                            <a
                                                                href={`https://real-time-chat-app-backend-1qh4.onrender.com${message.fileUrl}`}
                                                                target="_blank"
