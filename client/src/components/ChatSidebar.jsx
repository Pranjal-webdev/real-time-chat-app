...
const ChatSidebar = ({ onSelectConversation, onConversationCreated }) => {
    ...
    const handleProfileImageChange = async (event) => {
        ...
        try {
            ...
            const response = await axios.put(
                "https://real-time-chat-app-backend-1qh4.onrender.com://real-time-chat-app-backend-1qh4.onrender.com/api/users/profile-image",
                formData,
                {
                    headers: {
    ...
    const fetchReceivedRequestsCount = async () => {
        try {
            ...
            const response = await axios.get(
                "https://real-time-chat-app-backend-1qh4.onrender.com://real-time-chat-app-backend-1qh4.onrender.com/api/friend-requests/received",
                {
                    headers: {
                        Authorization: `Bearer ${token}`,
                    },
    ...
    const fetchSentRequests = async () => {
        ...
        try {
            ...
            const response = await axios.get(
                "https://real-time-chat-app-backend-1qh4.onrender.com://real-time-chat-app-backend-1qh4.onrender.com/api/friend-requests/sent",
                {
                    headers: {
                        Authorization: `Bearer ${token}`,
                    },
    ...
    const handleSearch = async (value) => {
        ...
        try {
            ...
            const response = await axios.get(
                `https://real-time-chat-app-backend-1qh4.onrender.com://real-time-chat-app-backend-1qh4.onrender.com/api/users/search?search=${value}`,
                {
                    headers: {
                        Authorization: `Bearer ${token}`,
                    },
    ...
    const handleSendRequest = async (userId) => {
        ...
        try {
            ...
            await axios.post(
                "https://real-time-chat-app-backend-1qh4.onrender.com://real-time-chat-app-backend-1qh4.onrender.com/api/friend-requests",
                                    ...
                                    <img
                                        src={
                                            profileImage.startsWith("http")
                                                ? profileImage
                                                : `https://real-time-chat-app-backend-1qh4.onrender.com://real-time-chat-app-backend-1qh4.onrender.com${profileImage}`
                                        }
                                        alt="Profile"
                                        ...
                                        <img
                                            src={
                                                user.profileImage.startsWith("http")
                                                    ? user.profileImage
                                                    : `https://real-time-chat-app-backend-1qh4.onrender.com://real-time-chat-app-backend-1qh4.onrender.com${user.profileImage}`
                                            }
                                            alt={user.name}
                                        ...
                                        <img
                                            src={
                                                otherUser.profileImage.startsWith("http")
                                                    ? otherUser.profileImage
                                                    : `https://real-time-chat-app-backend-1qh4.onrender.com://real-time-chat-app-backend-1qh4.onrender.com${otherUser.profileImage}`
                                            }
                                            alt={otherUser.name}
